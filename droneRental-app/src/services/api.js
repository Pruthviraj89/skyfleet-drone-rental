...
export const penaltyAPI = {
  ...
  getByBooking: (bookingId) => api.get(`/api/bookings/${bookingId}/penalties`),
...
export const undertakingAPI = {
  ...
  getByBooking: (bookingId) => api.get(`/api/bookings/${bookingId}/undertaking`),
...
export const ratingAPI = {
  ...
  getByDrone: (droneId) => api.get(`/api/drones/${droneId}/ratings`),
  
  // Get ratings for a booking
  getByBooking: (bookingId) => api.get(`/api/bookings/${bookingId}/ratings`),
...
export const adminAPI = {
  ...
  updateBookingStatus: (id, status) => api.put(`/api/admin/bookings/${id}/status`, { status }),
  
  // Get dashboard stats (admin only)
  getDashboardStats: () => api.get('/api/admin/dashboard'),
  
  // Get revenue reports (admin only)
  getRevenueReports: (period) => api.get('/api/admin/revenue', { params: { period } })
};
